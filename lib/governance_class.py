...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to curved "gobject list" output
    ...
    def curved_serialise(self):
        import curvelib
        return curvelib.SHIM_serialise_for_curved(self.serialise())
